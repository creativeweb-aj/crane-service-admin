...
class ValidationMessages(enum.Enum):
    ...
    # Project App
    crane_field_is_required = _('Crane field is required.')
    crane_not_found = _('Crane not found.')
    address_field_is_required = _('Address field is required.')
    image_field_is_required = _('Image field is required.')

    # About App
    designation_field_is_required = _('Designation field is required.')
    day_field_is_required = _('Day field is required.')
    start_time_field_is_required = _('Start time field is required.')
    end_time_field_is_required = _('End time field is required.')
    max_time_is_required = _('End time should be grater then start time.')

    # Customer App
    client_name_field_is_required = _('Client name field is required.')
    client_image_field_is_required = _('Client image field is required.')
    comment_field_is_required = _('Comment field is required.')

    # Social Page App
    social_page_field_is_required = _('Social page field is required.')
    social_page_not_found = _('Social page not found.')
...
# Email templates App
class ProjectAppMessages(enum.Enum):
    # Crane
    crane_has_been_added_successfully = _('Crane has been added successfully.')
    crane_has_been_updated_successfully = _('Crane has been updated successfully.')
    crane_has_been_deleted_successfully = _('Crane has been deleted successfully.')
    crane_has_been_deactivated_successfully = _('Crane has been deactivated successfully.')
    crane_has_been_activated_successfully = _('Crane has been activated successfully.')
    # Project
    project_has_been_added_successfully = _('Project has been added successfully.')
    project_has_been_updated_successfully = _('Project has been updated successfully.')
    project_has_been_deleted_successfully = _('Project has been deleted successfully.')
    project_has_been_deactivated_successfully = _('Project has been deactivated successfully.')
    project_has_been_activated_successfully = _('Project has been activated successfully.')


class ServiceAppMessage(enum.Enum):
...
class AboutAppMessage(enum.Enum):
    # About
    about_has_been_added_successfully = _('About has been added successfully.')
    about_has_been_updated_successfully = _('About has been updated successfully.')
    about_has_been_deleted_successfully = _('About has been deleted successfully.')
    about_has_been_deactivated_successfully = _('About has been deactivated successfully.')
    about_has_been_activated_successfully = _('About has been activated successfully.')
    # Key point
    key_point_has_been_added_successfully = _('Key point has been added successfully.')
    key_point_has_been_updated_successfully = _('Key point has been updated successfully.')
    key_point_has_been_deleted_successfully = _('Key point has been deleted successfully.')
    key_point_has_been_deactivated_successfully = _('Key point has been deactivated successfully.')
    key_point_has_been_activated_successfully = _('Key point has been activated successfully.')
    # Our value
    our_value_has_been_added_successfully = _('Our value has been added successfully.')
    our_value_has_been_updated_successfully = _('Our value has been updated successfully.')
    our_value_has_been_deleted_successfully = _('Our value has been deleted successfully.')
    our_value_has_been_deactivated_successfully = _('Our value has been deactivated successfully.')
    our_value_has_been_activated_successfully = _('Our value has been activated successfully.')
    # Person
    person_has_been_added_successfully = _('Person has been added successfully.')
    person_has_been_updated_successfully = _('Person has been updated successfully.')
    person_has_been_deleted_successfully = _('Person has been deleted successfully.')
    person_has_been_deactivated_successfully = _('Person has been deactivated successfully.')
    person_has_been_activated_successfully = _('Person has been activated successfully.')
    # Working day
    working_day_has_been_added_successfully = _('Working day has been added successfully.')
    working_day_has_been_updated_successfully = _('Working day has been updated successfully.')
    working_day_has_been_deleted_successfully = _('Working day has been deleted successfully.')
    working_day_has_been_deactivated_successfully = _('Working day has been deactivated successfully.')
    working_day_has_been_activated_successfully = _('Working day has been activated successfully.')


class CustomerAppMessage(enum.Enum):
    # Message
    message_has_been_deleted_successfully = _('Message has been deleted successfully.')
    # Testimonial
    testimonial_has_been_added_successfully = _('Testimonial has been added successfully.')
    testimonial_has_been_updated_successfully = _('Testimonial has been updated successfully.')
    testimonial_has_been_deleted_successfully = _('Testimonial has been deleted successfully.')
    testimonial_has_been_deactivated_successfully = _('Testimonial has been deactivated successfully.')
    testimonial_has_been_activated_successfully = _('Testimonial has been activated successfully.')


class SocialAppMessage(enum.Enum):
    # Social page
    social_page_has_been_added_successfully = _('Social page has been added successfully.')
    social_page_has_been_updated_successfully = _('Social page has been updated successfully.')
    social_page_has_been_deleted_successfully = _('Social page has been deleted successfully.')
    social_page_has_been_deactivated_successfully = _('Social page has been deactivated successfully.')
    social_page_has_been_activated_successfully = _('Social page has been activated successfully.')
    # Social link
    social_link_has_been_added_successfully = _('Social link has been added successfully.')
    social_link_has_been_updated_successfully = _('Social link has been updated successfully.')
    social_link_has_been_deleted_successfully = _('Social link has been deleted successfully.')
    social_link_has_been_deactivated_successfully = _('Social link has been deactivated successfully.')
    social_link_has_been_activated_successfully = _('Social link has been activated successfully.')
